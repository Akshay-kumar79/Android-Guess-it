...
class ChatMessageAdapter(
    ...
    var chatObjects: List<BaseModel> = emptyList()
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(holder){
            is AnnouncementViewHolder -> {
                holder.bind(chatObjects[position] as Announcement)
            }
            is IncomingChatMessageViewHolder -> {
                holder.bind(chatObjects[position] as ChatMessage)
            }
    ...
    inner class IncomingChatMessageViewHolder(val binding: ItemChatMessageIncomingBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    inner class OutgoingChatMessageViewHolder(val binding: ItemChatMessageOutgoingBinding) : RecyclerView.ViewHolder(binding.root) {
